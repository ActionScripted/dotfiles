# Generated by Powerlevel10k configuration wizard on 2023-05-04 at 20:38 EDT.
...
################################################################
# VPN Status (Cisco AnyConnect)
function prompt_vpn_status() {
    local state=DISABLED
    local icon=''

    if declare -f vpnstatusfile > /dev/null; then
        if vpnstatusfile; then
            state=ENABLED
            icon="󰒃"
        fi
    fi
    ...
    p10k segment -s $state -i $icon -t "$state"
}
...
() {
    ...
    #################################[ vpn_status ]##################################
    typeset -g POWERLEVEL9K_VPN_STATUS_DISABLED_BACKGROUND=005
    typeset -g POWERLEVEL9K_VPN_STATUS_DISABLED_CONTENT_EXPANSION=''
    typeset -g POWERLEVEL9K_VPN_STATUS_DISABLED_FOREGROUND=008
    #typeset -g POWERLEVEL9K_VPN_STATUS_DISABLED_VISUAL_IDENTIFIER_EXPANSION=''
    typeset -g POWERLEVEL9K_VPN_STATUS_ENABLED_BACKGROUND=002
    typeset -g POWERLEVEL9K_VPN_STATUS_ENABLED_CONTENT_EXPANSION='VPN'
    typeset -g POWERLEVEL9K_VPN_STATUS_ENABLED_FOREGROUND=008
    #typeset -g POWERLEVEL9K_VPN_STATUS_ENABLED_VISUAL_IDENTIFIER_EXPANSION=''
    ...
    function my_git_formatter() {
        ...
        local   modified='%8F' # black foreground
        local  untracked='%8F' # black foreground
